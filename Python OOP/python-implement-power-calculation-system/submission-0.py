class Hero:
    ...
    @staticmethod
    def calculate_effective_power(base_power: int, attribute: dict):
        attribute_bonus = sum(attribute.values())/len(attribute)
        effe_power = base_power * (1 + attribute_bonus)
        effe_power = round(effe_power, 1)
